...
const requests: IRequest = {
  ...
  tv: {
    ...
    actionMovies: `${BASE_URL}/discover/tv?api_key=${API_KEY}&language=en-US&with_genres=28`,
    comedyMovies: `${BASE_URL}/discover/tv?api_key=${API_KEY}&language=en-US&with_genres=35`,
    horrorMovies: `${BASE_URL}/discover/tv?api_key=${API_KEY}&language=en-US&with_genres=27`,
